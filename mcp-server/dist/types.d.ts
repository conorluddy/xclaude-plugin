...
export type XcodeResultData = BuildResultData | TestResultData | ListResultData | VersionResultData | BuildResultData;
export type SimulatorOperation = 'device-lifecycle' | 'app-lifecycle' | 'io' | 'push' | 'openurl' | 'list' | 'health-check' | 'get-app-container';
export type DeviceLifecycleSubOperation = 'boot' | 'shutdown' | 'create' | 'delete' | 'erase' | 'clone';
...
export type SimulatorResultData = DeviceLifecycleResultData | AppLifecycleResultData | ListResultData | HealthCheckResultData;
export type IDBOperation = 'tap' | 'input' | 'gesture' | 'describe' | 'find-element' | 'app' | 'list-apps' | 'check-accessibility' | 'targets';
